    ...
    <a href={props.href} onClick={props.onClick}>
      <Grid className="dropdown-content" container alignItems="center">
        ...
        <Grid
          container
          item
          direction={props.icon ? "row" : "column"}
...
function LangSelector(props) {
  ...
  useEffect(() => {
    ...
    window.addEventListener("click", (e) => {
      if (
        langRef.current?.classList.contains("open") &&
        !e.target?.classList.contains("lang-selector")
      ) {
    ...
    <div
      ...
      <div className="dropdown-container">
        <div className="dropdown-content-wrap">
          {langs
            .filter((item) => selectedLang.value !== item.value)
...
function Navbar(props) {
  ...
  const handleScroll = (e) => {
    if (
      e.currentTarget.pageYOffset > 0 &&
      navRef &&
      !navRef.classList.contains("shadow")
    ) {
  ...
  useEffect(() => {
    ...
    const elsSideMenu = document.querySelectorAll(
  ...
  return (
    <>
      ...
      <Grid
        ref={(ref) => (navRef = ref)}
        container
        className="navbar-wrap scrolled"
        style={{
          top: 0,
          position: "sticky",
          zIndex: 1000,
        ...
        <div className="navbar-content max-width--">
          ...
          <ul className="menu">
            ...
            <Typography name={"/"} variant="h5" className="menu--item">
              <Link href="/">{tempNavTranslation(route.locale, "home")}</Link>
            </Typography>
            {/* <Typography name={"/about"} variant="h5" className="menu--item"><Link href="/about">{t('nav.about')}</Link></Typography> */}
            <Typography name={"/about"} variant="h5" className="menu--item">
              <Link href="/about">
            ...
            <Typography
              ...
              <Link href="/solutions" className="menu--item-link dropdown-btn">
            ...
            <Typography
              ...
              <Link href="/posts" className="menu--item-link dropdown-btn">
            ...
            <Typography name={"/contact"} variant="h5" className="menu--item">
              <Link href="/contact">
          ...
          <div
            ...
            {openNavButton ? (
              <Icon style={{ color: "#fff" }} icon={faTimes} />
            ) : (
              <Icon icon={faBars} />
            )}
          </div>
          <div
            ...
            <ul className="side-menu">
              <Typography
                ...
                onClick={handleSideNavbar}
                variant="h5"
                className="menu--item side-menu-list--item">
                <Link href="/">
                  {/* {t('nav.home')} */}
