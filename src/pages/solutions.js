    ...
    <Grid className="solutions-container" style={{ width: "100%" }}>
      <div className="solutions-title">
        <Grid className="solutions-title-text-container">
          <Typography variant="h3" className="solutions-title-text">
            <span className="text-1">{t("solutions.title")}</span>
            <span className="text-2">{t("solutions.title2")}</span>
          </Typography>
          <Typography
            variant="subtitle1"
            ...
            return (
              <Parallax
                ...
                style={{
                  width: "100%",
                  borderBottom:
                    index !== content.length - 1 && "4px solid #fff",
                }}>
                <div
                  style={{
                    position: "absolute",
                ...
                <Grid
                  id={"solution-section-" + type}
                  className="solutions-content"
                  style={(type == "icon-4" && { padding: "5rem 0" }) || {}}>
                  <img
                    alt="solutions-icon"
                    className={"solutions-icon" + " " + type}
                    src={icon}
                  />
                  <Grid
                    className="solutions-text-container max-width--"
                    style={(type == "icon-4" && { width: "100%" }) || {}}>
                    <Typography
                      variant="h4"
                    ...
                    {bodyImg && (
                      <>
                        <img
                          ...
                          className="work-flow-chart"
                          src={bodyImg}
                          alt="work-flow-img"
                        />
                        <img
                          style={{ maxWidth: "25rem" }}
                          className="work-flow-chart small"
                          src={bodyImgSmall}
                          alt="work-flow-small-img"
                        />
                      </>
                    )}
                  ...
                  {type === "icon-1" && (
                    <Grid
                      container
                      className="solutions-analysis-stack"
                      direction="row"
                      ...
                      <div>
                        ...
                        <Typography
                          ...
                          <span className="stack-analysis-text">
                            {t("solutions.certified")}{" "}
                          </span>
                          <div>
                            <img
                              alt="python-logo"
                              className="solutions-analysis-logos"
                              src="/assets/solutions/python_logo.png"
                            />
                            <img
                              alt="powerbi-logo"
                              className="solutions-analysis-logos"
                              ...
                              src="/assets/solutions/powerbi_logo.png"
                            />
                            <img
                              alt="r-language-logo"
                              className="solutions-analysis-logos"
                              style={{ maxWidth: "3rem" }}
                              src="/assets/solutions/r_language_logo.png"
                            />
                          </div>
                        </Typography>
                      </div>
                  ...
                  {type === "icon-2" && (
                    <div
                      className="techs-container max-width--"
                      style={{
                        width: "100%",
                        margin: "0 auto",
                        marginTop: "4rem",
                      ...
                      <div
                        ...
                        <img
                          alt="django-logo"
                          className="solutions-analysis-logos"
                          style={{ maxWidth: "8.5rem", margin: "2rem 1rem" }}
                          src="/assets/solutions/tech_django.png"
                        />
                        <img
                          alt="react-logo"
                          className="solutions-analysis-logos"
                          style={{ maxWidth: "3.5rem", margin: "2rem 1rem" }}
                          src="/assets/solutions/tech_react.png"
                        />
                        <img
                          alt="node-logo"
                          className="solutions-analysis-logos"
                          style={{ maxWidth: "6rem", margin: "2rem 1rem" }}
                          src="/assets/solutions/tech_node.png"
                        />
                        <img
                          alt="mui-logo"
                          className="solutions-analysis-logos"
                          style={{ maxWidth: "3.5rem", margin: "2rem 1rem" }}
                          src="/assets/solutions/tech_materialui.png"
                        />
                        <img
                          alt="strapi-logo"
                          className="solutions-analysis-logos"
                          style={{ maxWidth: "9.5rem", margin: "2rem 1rem" }}
                          src="/assets/solutions/tech_strapi.png"
                        />
                      </div>
                    </div>
                  )}
