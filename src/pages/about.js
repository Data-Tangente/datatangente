    ...
    return(
        <Grid className="about-container" container style={{width:'100%'}}>
            ...
            <div className="about-body-container max-width--">
                ...
                >
                    <span style={{color:'#f05638'}}>Data Tangente</span> {t('aboutUs.dt1')}
                </Typography>
                <Typography
                    variant="subtitle1"
                ...
                <img alt="values-img" className="about-values-img" src={`/assets/about/${i18n.resolvedLanguage}/about_values.png`} />
                <div className="border-gradient horizontal small" style={{marginTop:'5rem'}}></div>
                <img alt="values-img-small" className="about-values-img small" src={`/assets/about/${i18n.resolvedLanguage}/about_values_small.png`} />
            </div>
        </Grid>
    );
}
