...
export const dateFormat = (date, lang) => {
  ...
  const formattedDate =
    newDate.getDate() +
    " " +
    newDate.toLocaleString(locale, { month: "long" }) +
    " " +
    newDate.getFullYear();
...
export const tempNavTranslation = (locale, value) => {
  const data = {
    ...
    es: {
      ...
      contact: "Contacto",
      analysisBody:
        "Soluciones y plataformas acorde a las necesidades de nuestros clientes",
      softwareBody: "Visualice nuestra línea de proceso",
      processBody:
        "Plataformas y programas personalizadas para nuestros clientes",
      analysis: "ANÁLISIS DE DATA",
      softwareDev: "DESARROLLO DE SOFTWARE",
      softwareDev1: "Desarrollo de Software",
      processLine: "NUESTRA LÍNEA DE PROCESO",
      processLine1: "Nuestra Línea de Proceso",
